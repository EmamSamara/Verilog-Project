// ============================================================
// FILE: tb_multiplier_cla.v  —  Testbench: Stage 2 CLA
// Run: iverilog -o tb_cla tb_multiplier_cla.v && vvp tb_cla
// Clock = 400 ns period (safe margin above 143 ns latency)
// ============================================================
`timescale 1ns/1ps

module tb_multiplier_cla;
    reg  [3:0]  x;
    reg  [7:0]  y;
    reg         clk;
    wire [11:0] res;

    multiplier_cla uut (.res(res),.x(x),.y(y),.clk(clk));
    ...
    initial begin
        ...
        $display("========================================");
        $display("  CLA Multiplier - Complete Verification");
    ...
    initial begin
        $dumpfile("tb_multiplier_cla.vcd");
        $dumpvars(0,tb_multiplier_cla);
    end
endmodule
